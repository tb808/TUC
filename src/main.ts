...
const controlsHTML = `<div class="control-grid"><div><kbd>W A S D</kbd><strong>Bewegen</strong><span>W / S in die Tiefe, A / D seitlich</span></div><div><kbd>J / K</kbd><strong>Jab / Cross</strong><span>Shift: Haken · Strg: Körper</span></div><div><kbd>U / I</kbd><strong>Low-Kicks</strong><span>Strg: Body-Kick · Shift: High-Kick</span></div><div><kbd>LEERTASTE</kbd><strong>Hohe Deckung</strong><span>Strg: tief / Sprawl</span></div><div><kbd>G</kbd><strong>Clinch / Übergang</strong><span>Shift + G: Takedown · R: lösen / aufstehen</span></div><div><kbd>W A S D + G</kbd><strong>Bodenposition wechseln</strong><span>Oben: vorarbeiten · Unten: befreien</span></div><div><kbd>J / K · U</kbd><strong>Ground & Pound / Armbar</strong><span>Armbar aus Mount · G halten zum Angriff</span></div><div><kbd>LEERTASTE · ESC</kbd><strong>Verteidigen / Pause</strong><span>Am Boden: Übergang / Armbar abwehren</span></div></div><p class="help-note">Achte auf deine Ausdauer: Leere Schläge kosten Kraft, saubere Treffer brauchen die richtige Distanz. Bei einer Armbar G halten; der Verteidiger hält die Leertaste. F3 öffnet die Diagnoseansicht.</p>`;
